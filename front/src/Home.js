    ...
    <div>
      ...
      <div className="container py-5" id="about">
        ...
        <div className="row pt-3">
          ...
          <div className="col-12 col-sm-6">
            <img
              src="https://image.shutterstock.com/image-vector/happy-group-people-jumping-on-260nw-518870674.jpg"
              class="img-fluid"
            />
          </div>
        </div>
      ...
      <div className="gradient">
        <div className="container py-5" id="whatwedo">
          ...
          <div className="row pt-3">
            <div className="col-12 col-sm-6">
              <img
                src="https://image.shutterstock.com/image-vector/happy-group-teen-university-student-600w-1101308990.jpg"
                class="img-fluid"
              />
            </div>
            <div className="col-12 col-sm-6">
              <p className="text-white">
                ...
                electronic typesetting, remaining essentially unchanged. It was
                popularised in the 1960s with the release of Letraset sheets
                containing Lorem Ipsum passages, and mre recently with desktop
                publishing software like Aldus PageMaker including versions of
                Lorem Ipsum.
              </p>
            </div>
      ...
      <div className="container pt-5">
        <div
          className="row d-flex  justify-content-center pb-3"
          id="becomeamember"
        >
